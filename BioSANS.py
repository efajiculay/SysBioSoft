...
def paramSet(method):
	...
	name = str(path.parent)+"\\"+datetime.now().strftime("%Y%m%d_%H%M%S")
	par = gui.Toplevel()
	...
	defs = [file_name["topology"],1,gui.StringVar(),1.0,100,1.5,False,False,False,method,10000,True,True,name,True,"","","",False,False]
...
if __name__ == "__main__":
	...
	menubut1 = gui.Menubutton(frame,text="      File      ",activebackground="#f2f20d",activeforeground="red",bg="#00cc00",fg="white")
	menubut1.menu =  gui.Menu ( menubut1, tearoff = 0 )
	menubut1["menu"] =  menubut1.menu
	LoadMenu = gui.Menu(frame,tearoff = 0 )
	...
	ConvMenu = gui.Menu(frame,tearoff = 0 )
	...
	menubut1.menu.add_cascade(label="Convert", menu=ConvMenu)
	menubut1.place(x=2,y=5)

	menubut2 = gui.Menubutton(frame,text="Analysis",activebackground="#f2f20d",activeforeground="red",bg="#00cc00",fg="white")
	menubut2.menu =  gui.Menu ( menubut2, tearoff = 0 )
	menubut2["menu"] =  menubut2.menu
	AnalMenu = gui.Menu(frame,tearoff = 0 )
	...
	ODEMenu = gui.Menu(frame,tearoff = 0 )
	...
	Rungek4 = gui.Menu(frame,tearoff = 0 )
	...
	Rungek4a = gui.Menu(frame,tearoff = 0 )
	...
	EulrTau = gui.Menu(frame,tearoff = 0 )
	...
	EulrTau2 = gui.Menu(frame,tearoff = 0 )
	...
	#Itoints = gui.Menu(frame,tearoff = 0 )
	...
	#Stratint = gui.Menu(frame,tearoff = 0 )
	...
	cletauA = gui.Menu(frame,tearoff = 0 )
	...
	cletauA2 = gui.Menu(frame,tearoff = 0 )
	...
	TauLMenu = gui.Menu(frame,tearoff = 0 )
	...
	LNAMenu = gui.Menu(frame,tearoff = 0 )
	...
	ParEsMenu = gui.Menu(frame,tearoff = 0 )
	...
	menubut2.place(x=71,y=5)
	
	menubut3 = gui.Menubutton(frame,text="Post Proc.",activebackground="#f2f20d",activeforeground="red",bg="#00cc00",fg="white")
