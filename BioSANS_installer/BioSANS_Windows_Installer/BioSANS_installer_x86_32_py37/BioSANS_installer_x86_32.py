...
pyInsexe = path.join(Bcwd,"python-3.7.4.exe")
...
if not path.isfile(path.join(Bcwd,"python-3.7.4.exe")): 
...
try:
	mkdir("C:/BioSANS2021/Python37x86_32",0o777)
except:
	pass
...
#system("C:/BioSANS2021/Python37x86_32/Python37/python.exe "+WinIns)
p = Popen(["C:/BioSANS2021/Python37x86_32/Python37/python.exe", WinIns], stdout = PIPE, stderr = STDOUT, shell = True, creationflags = REALTIME_PRIORITY_CLASS)
...
print("##################################################################################")
print("#                                                                                #")
print("#  Python terminal can be found in C:/BioSANS2021/Python37x86_32/Python37/python  #")
print("#  To run BioSANS GUI, type either one of the following 3 commands:              #")
print("#                                                                                #")
print("#  BioSANS                                                                       #")
print("#  C:/BioSANS2021/Python37x86_32/Python37/python -m BioSANS2020                   #")
print("#  C:/BioSANS2021/Python37x86_32/Python37/python -m BioSANS2020.BioSANS           #")
print("#                                                                                #")
print("#  To run BioSSL CLI, type either one of the following 2 commands:               #")
print("#                                                                                #")
print("#  BioSSL                                                                        #")
print("#  C:/BioSANS2021/Python37x86_32/Python37/python -m BioSANS2020.BioSSL            #")
print("#                                                                                #")
print("##################################################################################")
print()
